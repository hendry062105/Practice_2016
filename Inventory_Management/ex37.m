IFt = 0;%(kg) IFt
IIt = 892;                                 %(kg) IIt  SUPOSICIÓN PARRADO PÁG #29, SITUACIÓN B PÁG 37                                 
%CANTIDADES QUE COMPRAN LOS CLIENTES
Dt = [400 400 400 400 400 400 400]%SITUACIÓN E
%Dt  =  [14 5 14 7 14 4 9 14 11] ???
Qt = 892;%"VARIABLE DE DESICIÓN"
